...
const EditarPelicula = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const { data } = await axios.get(`httpsss://${import.meta.env.VITE_IP}/pelicula/by-codigo?codigo=${codigo}`);
                setPelicula(data);
            } catch (error) {
    ...
    const guardarPelicula = async (e) => {
        ...
        await axios.put(`httpss://${import.meta.env.VITE_IP}/autor/editar`, autor)
            .then((res) => {
        ...
        await axios.put(`httpss://${import.meta.env.VITE_IP}/pelicula/editar`, peliculaData)
            .then((res) => {
                navigate('/pelicula'); 
            })
            .catch((err) => {
